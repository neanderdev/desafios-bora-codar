...
Desafio `23` do [#boraCodar](https://boracodar.dev/). Desenvolver um formulário multi step. 
...
<p align="center">
  <img alt="Imagem de um formulário multi step" src="./.github/preview.png" width="100%">
</p>
