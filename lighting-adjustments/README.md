...
Desafio `24` do [#boraCodar](https://boracodar.dev/). Desenvolver um componente de ajustes de iluminação. 
...
<p align="center">
  <img alt="Imagem de um componente de ajustes de iluminação" src="./.github/preview.png" width="100%">
</p>
