...
Desafio `35` do [#boraCodar](https://boracodar.dev/). Desenvolver uma página de reminder para beber água. 
...
<p align="center">
  <img alt="Imagem de uma página de reminder para beber água" src="./.github/preview.png" width="100%">
</p>
